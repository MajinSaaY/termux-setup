...
read NAME
echo -e "Ael: Olá $NAME (ㆁωㆁ)" >> /data/data/com.termux/files/usr/etc/motd

#Initial setup
pkg update -y 
pkg in tmux vim zsh wget aria2 megatools ffmpeg python git man termux-api -y
pip install --upgrade pip
pip install yt-dlp gallery_dl
...
#Termux-url-opener
mkdir ~/bin
wget --no-check-certificate --output-document="/data/data/com.termux/files/home/bin/termux-url-opener" "https://raw.githubusercontent.com/MajinSaaY/termux-setup/main/termux-url-opener_PT-BR"
chmod +x ~/bin/termux-url-opener

#Widget (Clipboard)
mkdir ~/.shortcuts && mkdir ~/.shortcuts/icons
wget --no-check-certificate --output-document="/data/data/com.termux/files/home/.shortcuts/Clipboard" "https://raw.githubusercontent.com/MajinSaaY/termux-setup/main/Clipboard_PT-BR"
